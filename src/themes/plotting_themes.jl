...
function publication_theme(; fullscreen = false)
    ...
    Theme(backgroundcolor = :white,
          ...
          linewidth = 4.5,
          markersize = 20,
          palette = (color = ["#4263eb", "#f03e3e", "#f76707", "#22b371", "#5f3dc4",
                         "#fcc419", "#c2255c", "#1098ad", "#cf6db0",
                     ],
                     patchcolor = ["#4263eb", "#f03e3e", "#f76707", "#22b371", "#5f3dc4",
                         "#fcc419", "#c2255c", "#1098ad", "#cf6db0",
                     ],
                     marker = [:circle, :utriangle, :rect, :dtriangle, :diamond,
                         :xcross, :hexagon, :star5]),
